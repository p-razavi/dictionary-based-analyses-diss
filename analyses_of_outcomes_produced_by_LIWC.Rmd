...
ext_dic_df_plot <- ext_dic_df_plot %>% 
        mutate(construct = gsub("Weighted Reflection Reorganization", "WRR", ext_dic_df_plot$construct))

all_dic_df_plot <- rbind(ext_dic_df_plot, int_basicexpanddic_df_plot) %>% 
